...
const projects = [
  ...
  },
  {
    ...
    desc: "A Platform Design for Donate Left over food of hotels to Eldery Homes & Child Homes - Reduce Food Wastage.",
    tags: ["Java", "JavaFX", "SQL", "Layered"],
    icon: Code2,
    year: "2025",
    role: "Backend Developer",
    accent: "accent",
    image: "/assets/ZEIDOT.jpg",
    size: "small",
  },
  {
  ...
  },
  {
    ...
    desc: "Centralized Platform for Find Missing Pets - Users Can Post Lost Pets and Also Found Pets",
    tags: ["Spring Boot", "Data JPA", "React js"],
    icon: Brain,
    year: "2025",
